...
const info = {
  ourHistory: {
    ...
    section01: {
      ...
      subtitle: "",
      text: `Our story begins in 2011 when Artworks Brands was established in California as a
  ...
  whoWeAre: {
    ...
    section01: {
      ...
      button: "ABOUT US",
      subtitle: "",
      text: `Like any true artist, we believe in the individuality and
  ...
  whatWeDo: {
    ...
    section01: {
      ...
      button: "OUR BUSINESS",
      subtitle: "",
      text: `We cover all areas of creative entertainment in-house, which enables us to
...
export default function Section() {
  const oneBullet = useRef();
  const [oneHovering, setOneHovering] = useState(false);
  const oneContent = useRef();
  const twoBullet = useRef();
  const [twoHovering, setTwoHovering] = useState(false);
  const twoContent = useRef();
  const threeBullet = useRef();
  const [threeHovering, setThreeHovering] = useState(false);
  const threeContent = useRef();
  const fourBullet = useRef();
  const [fourHovering, setFourHovering] = useState(false);
  const fourContent = useRef();
  // const fiveBullet = useRef();
  // const [fiveHovering, setFiveHovering] = useState(false);
  // const fiveContent = useRef();

  // -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
  const scrollArea = useRef();
  const ourHistory = useRef();
  const whoWeAre = useRef();
  const whatWeDo = useRef();
  const whereToFindUs = useRef();

  const ourHistoryBullet = useRef();
  const whoWeAreBullet = useRef();
  const whatWeDoBullet = useRef();
  const whereToFindUsBullet = useRef();

  useEffect(() => {
    const _scrollArea = scrollArea.current;
    const _ourHistory = ourHistory.current;
    const _whoWeAre = whoWeAre.current;
    const _whatWeDo = whatWeDo.current;
    const _whereToFindUs = whereToFindUs.current;
    const _ourHistoryBullet = ourHistoryBullet.current;
    const _whoWeAreBullet = whoWeAreBullet.current;
    const _whatWeDoBullet = whatWeDoBullet.current;
    const _whereToFindUsBullet = whereToFindUsBullet.current;

    function handleScroll() {
      const scrollAreaRect = _scrollArea.getBoundingClientRect();
      const scrollAreaCenter = scrollAreaRect.height / 2 + scrollAreaRect.top;

      function distances(title, bullet) {
        const titleRect = title.getBoundingClientRect();
        const titleCenter = titleRect.height / 2 + titleRect.top;
        const titleDeltaFromCenter = scrollAreaCenter - titleCenter;
        const scrollAreaDistanceToBounds = Math.abs(scrollAreaRect.height / 2);
  ...
  return (
    <div className="flex flex-row h-full pl-2 md:pl-12 py-4">
      ...
      >
        <div ref={ourHistoryBullet} className="v-text">
          Our History
        </div>
        <div ref={whoWeAreBullet} className="v-text">
          Who we are today
        </div>
        <div ref={whatWeDoBullet} className="v-text">
          What we do
        </div>
        <div ref={whereToFindUsBullet} className="v-text">
          Where to Find Us
        </div>
      </div>
      <div
        ...
        style={{ direction: "rtl" }}
      >
        <div className="mx-4 md:mx-10" style={{ direction: "ltr" }}>
          <div className="mt-96">
            <div
              ref={ourHistory}
          ...
          <div className="my-40">
            ...
            <div
              className="font-poppins text-justify"
              dangerouslySetInnerHTML={{ __html: info.whoWeAre.section01.text }}
            />
          </div>
          <div className="my-40">
            <div
            ...
            <div
              className="font-poppins text-justify"
              dangerouslySetInnerHTML={{ __html: info.whatWeDo.section01.text }}
            />
            <div className="flex">
              <div className="grid grid-flow-col my-10 flex-auto">
                <div
                  ...
                  onFocus={() => handleOnHover(setOneHovering, oneHovering)}
                ...
                <div
                  ...
                  onFocus={() => handleOnHover(setTwoHovering, twoHovering)}
                ...
                <div
                  ref={threeBullet}
                  onMouseOver={() =>
                    handleOnHover(setThreeHovering, threeHovering)
                  }
                  onFocus={() => handleOnHover(setThreeHovering, threeHovering)}
                  onMouseLeave={() =>
                    handleLeave(setThreeHovering, threeHovering)
                  }
                ...
                <div
                  ref={fourBullet}
                  onMouseOver={() =>
                    handleOnHover(setFourHovering, fourHovering)
                  }
                  onFocus={() => handleOnHover(setFourHovering, fourHovering)}
                  onMouseLeave={() =>
                    handleLeave(setFourHovering, fourHovering)
                  }
              ...
              <div className="container my-auto w-1/2 p-2">
                {oneHovering && (
                  ...
                  >
                    <div className="">{info.whatWeDo.bullets.one.title}</div>
                    <div className="">{info.whatWeDo.bullets.one.text}</div>
                  </div>
                )}
                {twoHovering && (
                  <div
                    ...
                    className="
                                    ...
                                    text-sm text-justify"
                  >
                    <div className="">{info.whatWeDo.bullets.two.title}</div>
                    <div className="">{info.whatWeDo.bullets.two.text}</div>
                  </div>
                )}
                {threeHovering && (
                  <div
                    ...
                    className="
                                    ...
                                    text-sm text-justify"
                  >
                    <div className="">{info.whatWeDo.bullets.three.title}</div>
                    <div className="">{info.whatWeDo.bullets.three.text}</div>
                  </div>
                )}
                {fourHovering && (
                  <div
                    ...
                    className="
                                    ...
                                    text-sm text-justify"
                  >
                    <div className="">{info.whatWeDo.bullets.four.title}</div>
                    <div
                      className=""
                      dangerouslySetInnerHTML={{
                        __html: info.whatWeDo.bullets.four.text,
                      }}
                    />
                  </div>
                )}
