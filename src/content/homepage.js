var info = [
    {
        heading: `<div>Our<br>History</div>`,
        listOfSections: [
            {
        ...
        listOfSections: [
            {
                ...
                text:
                    ...
                    for most of the properties they have represented in the United
                    States and Latin America. We pride ourselves on having been a part
                    of success stories that are still alive. Artworks has contact with major
                    TV stations in several countries and is quick in reacting to new
                    opportunities in Home Entertainment and A/SVOD systems. In
                    addition, we have an unbeatable network that includes diverse TV,
                    film and digital contents producers. This allows us to have access to
                    several world catalogs and offer our partners and clients the perfect
                    blend of contents.`
            },
            {
